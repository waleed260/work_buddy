...
## 2026-06-25 - Informational Parity in State Transitions
**Learning:** Informational Parity Principle — When transitioning tasks between states (e.g., from 'In Progress' to 'Completed'), metadata like priority markers and due dates should be maintained to provide closure and preserve user context regarding original task importance. Additionally, transforming dry "zero states" into encouraging reinforcement loops improves user morale in productivity tools.
**Action:** Ensure all metadata available in active states remains visible in historical/completed views. Always replace empty placeholders with positive, human-centric reinforcement messages.
