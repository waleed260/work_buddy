...
def _get_todays_schedule() -> str:
    ...
    if not events:
        return "📅 Your schedule is clear! Time to focus on your personal growth or take a well-deserved break. ✨"
...
def _get_tasks(completed: Optional[bool] = None) -> str:
    ...
    if not filtered:
        if completed is False:
            return "📋 All caught up! You've crushed all your tasks. Enjoy the extra breathing room! 🎉"
    ...
    for task in filtered:
        ...
        # Visual hierarchy: Status -> Priority Emoji -> Title
